later = function () {
    ...
    return Array.prototype.indexOf || (Array.prototype.indexOf = function (e) {
        ...
        for (var r = n[0], a = n[1], i = t.length, u = 0 === t[i - 1] && 0 !== r ? a : 0, o = e, f = t.indexOf(e), d = o; o === (t[f] || u);)
            if (o++, o > a && (o = r), f++, f === i && (f = 0), o === d) return;
        return o
        ...
        for (var r = n[0], a = n[1], i = t.length, u = 0 === t[i - 1] && 0 !== r ? a : 0, o = e, f = t.indexOf(e), d = o; o === (t[f] || u);)
            if (o--, r > o && (o = a), f--, -1 === f && (f = i - 1), o === d) return;
        return o
    }, e.day = e.D = {
        name: "day",
        range: 86400,
        ...
        function n(t, n, x, g, p) {
            ...
            for (a(t, h, T, x), u(t, w, O, x); E-- && k && (D = m(T, Y)) && (!g || !Y(D, g));)
                if (y && (o(t, w, O, D), M = v(t, O, D))) i(t, h, T, M);
                else {
                    if (p) {
                        var V = l(O, Y);
                        M = c(t, h, T, D, V);
                        ...
                        if (b && I[R].getTime() === b[C].getTime() ? (b[C] = I[C], k++) : (b = I, S.push(b)), !M) break;
                        i(t, h, T, M)
                    } else S.push(N ? new Date(Math.max(x, D)) : d(h, T, D, g)), f(t, h, T, D);
                    k--
        ...
        function u(t, n, r, a) {
            for (var i = (s(t), 0), u = n.length; u > i; i++) {
                var o = n[i].start(t, a);
        ...
        function r() {
            var e = Date.now(),
                n = i.next(2, e);
            if (!n[0]) return void(a = void 0);
            var u = n[0].getTime() - e;
            1e3 > u && (u = n[1] ? n[1].getTime() - e : 1e3), a = 2147483647 > u ? setTimeout(t, u) : setTimeout(r, 2147483647)
        }
        ...
        function u(e, t, n) {
            var r = {},
                i = {};
            1 === n ? (a(t, "D", 1, 3), a(t, "d", s.MON, s.FRI), a(r, "D", 2, 2), a(r, "d", s.TUE, s.FRI), a(i, "D", 3, 3), a(i, "d", s.TUE, s.FRI)) : (a(t, "D", n - 1, n + 1), a(t, "d", s.MON, s.FRI), a(r, "D", n - 1, n - 1), a(r, "d", s.MON, s.THU), a(i, "D", n + 1, n + 1), a(i, "d", s.TUE, s.FRI)), e.exceptions.push(r), e.exceptions.push(i)
        }
        ...
        function o(e, t, r, i, u, o) {
            ...
            if ("*" !== v && "0" !== v) {
                var l = v.split("-");
                i = n(l[0], o, u), u = n(l[1], o, u) || u
            }
            a(t, r, i, u, d)
        }

        function f(e, t, r, f, d, v) {
            var l, c, s = t.schedules,
                m = s[s.length - 1];
            "L" === e && (e = f - 1), null !== (l = n(e, v, d)) ? a(m, r, l, l) : null !== (l = n(e.replace("W", ""), v, d)) ? u(t, m, l) : null !== (l = n(e.replace("L", ""), v, d)) ? i(s, m, l, f - 1) : 2 === (c = e.split("#")).length ? (l = n(c[0], v, d), i(s, m, l, n(c[1]))) : o(e, m, r, f, d, v)
        }
        ...
        return {
            ...
            customModifier: function (t, n) {
                var r = e.modifier[t];
                if (!r) throw new Error("Custom modifier " + t + " not recognized!");
        ...
        function r(e) {
            var t, r, a, i, u, o, f = e instanceof Array ? e : [e],
                d = /\s+/;
